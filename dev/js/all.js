...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Selector = function () {\n    function Selector(config) {\n        _classCallCheck(this, Selector);\n\n        this.selectClass = \".selector\";\n        this.selectList = \".selector__list\";\n        this.selectListItem = \".selector__list-item\";\n        this.selectedItem = \".selector__selected\";\n        this.protoClass = \".selector-proto\";\n        this.activeClass = \"selector__active\";\n\n        this.init();\n        this.setListeners();\n    }\n\n    _createClass(Selector, [{\n        key: \"init\",\n        value: function init() {\n            var arrSelect = Array.from(document.querySelectorAll(this.protoClass));\n\n            arrSelect.forEach(function (el) {\n                var listItem = el.querySelectorAll('option');\n                var list = '';\n                for (var i = 0; i < listItem.length; i++) {\n                    if (i !== 0) list += \"<div class=\\\"selector__list-item\\\" data-item=\\\"\" + i + \"\\\">\" + listItem[i].textContent + \"</div>\";\n                }var markup = \"\\n                <div class=\\\"selector__selected\\\" target=\\\"\" + el.dataset.target + \"\\\">\" + el.dataset.placeHolder + \": </div>\\n\\n                <div class=\\\"selector__list\\\">\\n                    \" + list + \"\\n                </div>\\n            \";\n\n                var div = document.createElement('div');\n                div.className = \"selector\";\n                div.innerHTML = markup;\n                div.dataset.ID = el.dataset.id;\n\n                var parent = el.parentElement;\n                parent.insertBefore(div, el.nextSibling);\n            });\n        }\n    }, {\n        key: \"setListeners\",\n        value: function setListeners() {\n            var _this = this;\n\n            var arrSelector = document.querySelectorAll(this.selectClass);\n            var arrSelect = document.querySelectorAll(this.protoClass);\n\n            for (var i = 0; i < arrSelector.length; i++) {\n                arrSelector[i].addEventListener('click', function (e) {\n\n                    if (e.target.classList.contains(_this.selectedItem.slice(1))) {\n                        console.log('was clicked');\n                        e.target.parentElement.classList.toggle(_this.activeClass);\n                    } else {\n                        var val = e.target.textContent;\n                        var listItem = Array.from(e.target.parentElement.querySelectorAll('div'));\n\n                        listItem.forEach(function (el) {\n                            return el.classList.remove('selected');\n                        });\n                        e.target.classList.add('selected');\n\n                        console.log(e.target.parentElement.previousElementSibling);\n\n                        e.target.parentElement.previousElementSibling.innerHTML = val;\n                        var select = e.target.parentElement.parentElement.previousElementSibling;\n                        select.querySelectorAll('option')[e.target.dataset.item].setAttribute('selected', true);\n\n                        e.target.parentElement.parentElement.classList.toggle(_this.activeClass);\n                    }\n                }, true);\n            }\n        }\n    }]);\n\n    return Selector;\n}();\n\nexports.default = Selector;\n\n//# sourceURL=webpack:///./src/js/modules/Selector.js?");
...
eval("module.exports = __webpack_require__.p + \"css/main.css?858b9b41faf3980ac21f0630324a5358\";\n\n//# sourceURL=webpack:///./src/sass/main.scss?");
